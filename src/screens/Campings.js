...
import * as mock from "../mocks/campings";
...
class Campings extends React.Component {
  ...
  renderList() {
    ...
    const mapSpots =
      filters.type === "all"
        ? campings
        : campings.filters((camping) => camping.type === filters.type);
            ...
            <View style={{ flex: 1, flexDirection: "row" }}>
              ...
              <View style={styles.campingInfo}>
                <Icon.FontAwesome
                  ...
                  size={12}
                />
                <Text styles={{ marginLeft: 4, color: "#FF7657" }}>
...
const moduleState = ({ campings }) => ({
  campings: campings.spots,
